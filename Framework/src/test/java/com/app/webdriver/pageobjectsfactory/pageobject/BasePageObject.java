package com.app.webdriver.pageobjectsfactory.pageobject;
...
import com.app.webdriver.common.core.EmailUtils;
import com.app.webdriver.common.core.element.JavascriptActions;
import com.app.webdriver.common.core.element.Wait;
import com.app.webdriver.common.core.purge.PurgeMethod;
...
public class BasePageObject {
	...
	protected void scrollAndClick(List<WebElement> elements, int index) {
		jsActions.scrollToElement(elements.get(index));
