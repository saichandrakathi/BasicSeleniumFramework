...
public class VelocityWrapper {
	...
	private static final String LAST_LOG_ROW_TEMPLATE_PATH = "lastLogRow.vm";
	  ...
	  private static final String
	      ERROR_LOG_ROW_WO_SCREENSHOT_AND_SOURCE_TEMPLATE_PATH
	  ...
	  static void fillLogRow(List<LogData> list, String command, String description) {
	    ...
	    context.put(
	        "className",
	        "\"" + list.stream().map(e -> e.cssClass()).collect(Collectors.joining(" ")) + "\""
	    );
	  ...
	  static String fillErrorLogRow(List<LogData> list, String command, long imageCounter) {
	    StringBuilder builder = new StringBuilder();
	  ...
	  static String fillErrorLogRowWoScreenshotAndSource(List<LogData> list, String command) {
	    StringBuilder builder = new StringBuilder();
	  ...
	  static void fillLogRowWithScreenshot(
	      List<LogData> list, String command, String description, long imageCounter
	  ) {
	    StringBuilder builder = new StringBuilder();
	  ...
	  static String fillHeader(
	      String date,
	      String polishDate,
	      String browser,
	      String os,
	      String testingEnvironmentUrl,
